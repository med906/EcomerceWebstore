                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input step=".01" type="number" placeholder="Sale Price (0 for not on sale!)" class="form-control input-md" wire:model="sale_price"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="file" placeholder="Product Image" class="form-control input-md" wire:model="image"/>
                                @if($image)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="file" placeholder="Product Image" class="form-control input-md" wire:model="images" multiple/>
                                @if($images)
