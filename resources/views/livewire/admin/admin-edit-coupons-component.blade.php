                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="updateCoupon">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input step=".01" type="text" placeholder="Coupon Value" class="form-control input-md" wire:model="value"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input step=".01"  type="text" placeholder="Coupon Cart Value" class="form-control input-md" wire:model="cart_value"/>
