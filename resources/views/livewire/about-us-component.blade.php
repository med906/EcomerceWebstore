    ...
    <main id="main" class="main-site">
        ...
        <div class="container">
            ...
            <div class="aboutus-info style-center">
                <b class="box-title">{{$info->title}}</b>
                <p class="txt-content">{{$info->companyInfo}}</p>
            </div>
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="{{$member->name}}">
                                    <figure> <img src="{{asset('assets/images/members')}}/{{$member->image}}" width="120" alt="{{$member->name}}">
                                    </figure>
                                </a>
                            </div>
                            <div class="info">
                                ...
                                <p class="desc">{{$member->teamDescription}}</p>
                            </div>
                        </div>
                        @endforeach
