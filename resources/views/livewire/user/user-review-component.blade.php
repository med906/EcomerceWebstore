            ...
            <div class="col-md-12">
                <div class="wrap-review-form">
                    @if(\Illuminate\Support\Facades\Session::has('message'))
                        <div class="alert alert-info" role="alert">{{\Illuminate\Support\Facades\Session::get('message')}}</div>
                    @endif
                    <div id="comments">
                        <h2 class="woocommerce-Reviews-title"><span>Add review for</span></h2>
                        <ol class="commentlist">
                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                <div id="comment-20" class="comment_container">
                                    <img alt="" src="{{ asset('assets/images/products')}}/{{$orderedItems->product->image}}" height="200" width="200">
                                    <div class="comment-text">
                                        <br>
                                        <p style="font-size: 20px" class="meta">
                                           <strong class="woocommerce-review__author">{{$orderedItems->product->name}}</strong>
                                        </p>
                                    </div>
                                </div>
                            </li>
